...
>If port forwarding is set up for your database container, you may be be able to use a secial DNS `host.docker.internal` or IP `172.0.17.1` in your JDBC URL to connect to your database from within the build/run containers.  
>
